...
#Discard trip upload (ExcelV3 sheet development code)
#Use R3.1.2 64-bit version

library(RODBC)
#options(java.parameters = "-Xmx1024m")
#packageurl <- "http://cran.r-project.org/src/contrib/Archive/XLConnect/XLConnect_0.2-10.tar.gz"
...
SQLServer = 'VMFSSTST02'       #test DB
#SQLServer = 'VMFSSSQL02'        #live DB (server due to change to VMFSSSQL02)
DBName = 'FEAS_DemDiscards'

#set wd
setwd ('//galwayFS03/fishdata/Discards/Discards Excel For Upload/')
...
#Michael 25/01/2017 upload of trip FAT/CHD/16/12 to test and live DB
#cruise.code <- "FAT/ROS/16/7" #uploaded to live DB 13/02/2017
#cruise.code <- "FAT/CTB/16/10" #uploaded by SJM to live DB 14/02/2017 Happy Valentine's Day 
#cruise.code <- "FAT/ROS/16/8" #uploaded by SJM to live DB 02/03/2017
#cruise.code <- "FAT/ROS/17/1" #uploaded by SJM to live DB 25/07/2017
#cruise.code <- "FAT/ROS/17/4" #uploaded by SJM to live DB 25/07/2017
#cruise.code <- "FAT/ROS/17/4" #uploaded by SJM to live DB 28/08/2017
cruise.code <- "FAT/CTB/17/5"
